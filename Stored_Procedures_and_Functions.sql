...
drop procedure if exists latefee(customer integer, numeric);
create or replace procedure latefee(customer integer,latefeeAmount decimal)
language plpgsql
as $$
begin
...
drop function add_actor(integer, VARCHAR, VARCHAR, TIMESTAMP);
